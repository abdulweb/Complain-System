...
<form class="form-inline frm" method="post" action="search_adm.php" enctype="multipart/form-data">
...
#edited here not in the old version
if($category=='Grieviance'){
	$sql = "SELECT * from complaint where complaint_category= 'Accomodation' or complaint_category= 'Results' ORDER BY priority ";
	$result = mysqli_query($connect, $sql);
}
else{
	$sql = "SELECT * from complaint where complaint_category= '$category' ORDER BY priority";
	$result = mysqli_query($connect, $sql);
}
#ended here
$count_pend = 0;
