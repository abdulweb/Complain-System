...
if(array_key_exists('submit', $_POST)){
	if(isset($_POST['record'])){
		...
		$sql = "SELECT * from complaint WHERE admission_number = '$admission_no'AND complaint_category = '$category' ";
		$result = mysqli_query($connect, $sql);
		}
		else{
		$date = mysqli_real_escape_string($connect,$_POST['date']);
		$sql = "SELECT * from complaint WHERE date = '$date'AND complaint_category = '$category' ";
		$result = mysqli_query($connect, $sql);
		}
