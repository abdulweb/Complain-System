...
<!-- second row -->
<div class = "col-md-9">
<h2 class = "h2-responsive"> View Complaint</h2>
<hr class="mb-4">
<?php
$msg ="";
if (!empty($msg)) {
			...
			<div class='col-md-9'>
				<div class='card card-success text-center'>".
					"<div class='card-block'>".
						"<p class='white-text error'>" . $msg . "</p> </div> </div>
				<hr class = 'mb-2'>
			</div>
		</div>
	";
...
$sql = "SELECT * from complaint where admission_number = '$user' ";
			...
			<tbody>
				...
				echo"
					...
					if ($rowstatus == "Answered"){
						echo"
					<td> <a href='view_decision.php?id=$rowid' class = 'text-success'>". $rowstatus ."</a></td>";
					}
					else{
						echo"
					<td> <a href='view_decision.php?id=$rowid' class = 'text-danger'>". $rowstatus ."</a></td>";	
					}
				echo"
				</tr>
			</tbody>";
