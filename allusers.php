...
<!-- second row -->
<div class = "col-md-9">
<h2 class = "h2-responsive"> Student Information</h2>
<hr class="mb-4">
</div>
</div>
<?php
...
$sql = "SELECT * from auth, student_reg  where  auth.username = student_reg.admission_number ";
		  ...
		  echo "
			<tbody>
				<tr>
					...
					<td>".$row["username"]."</td>
					<td>".$row["password"]."</td>
					<td> <a href=\"update_student.php?id=$rowid \"> Edit </a> </td>
                	<td> <a href=\"delete_student.php?id=$rowid \" onclick=\"return confirm('Are you sure you wish to delete this Record?');\">Delete</a></td>
					";
				/*echo"
