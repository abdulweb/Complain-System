...
<head>
		...
		<link href="bootstrap-datepicker-master/dist/css/bootstrap-datepicker3.min.css" rel="stylesheet">
...
<form class="form-inline frm" method="post" action="search.php" enctype="multipart/form-data">
	...
	<!--<input type="text"  class="form-control mr-sm-2" name = "date" id = "date">
<button class="btn btn-outline-success btn-sm my-0" value = "submit" name="submit">Search </button>-->
